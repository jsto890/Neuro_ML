#!/usr/bin/env python3
"""
Complete Radiomics Classification Workflow
==========================================
...
def setup_logging(output_dir):
    ...
    log_file = output_dir / f"complete_workflow_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def create_output_directory(output_dir):
    ...
    output_path = Path(output_dir) / f"radiomics_results_{timestamp}"
    ...
    try:
        ...
        summary = {
            'workflow_info': {
                ...
                'pipeline_version': 'Improved Optimized Pipeline',
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Complete Radiomics Classification Workflow",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Run with default settings
  python complete_workflow.py --input radiomics_features.csv --output results/
  
  # Run with custom configuration
  python complete_workflow.py --input radiomics_features.csv --output results/ --config my_config.yaml
  
  # Run with custom random seed
  python complete_workflow.py --input radiomics_features.csv --output results/ --random-state 123
        """
    )
