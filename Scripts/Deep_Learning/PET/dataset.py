...
class PETDataset(Dataset):
    ...
    Expects:
      ...
      - A data_root directory containing petprep/<subject>/pet/<subject>_desc-preproc_FDG_brain_zscore.nii.gz
    """
    ...
    def __init__(self, csv_path: str, data_root: str):
        ...
        Args:
            ...
            data_root (str): root folder where petprep/<subject>/pet/... lives.
        """
        # Read CSV normally
    ...
    def __getitem__(self, idx: int):
        ...
        # Construct the path to the z-scored FDG PET brain image
        img_path = os.path.join(
            self.data_root,
            "petprep",
            sid,
            "pet",
            f"{sid}_space-MNI152NLin2009cAsym_res-2_desc-preproc_FDG_brain_zscore.nii.gz"
        )
