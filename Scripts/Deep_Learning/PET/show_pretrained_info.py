...
Displays information about available pretrained models for PET classification.
"""

from models_pet import get_pretrained_model_info

def main():
    print("="*80)
    print("PRETRAINED MODEL INFORMATION FOR PET CLASSIFICATION")
    print("="*80)
    ...
    print("python train_pet.py --master_csv ~/data/pet_labels.csv \\")
    print("    --data_root ~/data/preprocessed/PET \\")
