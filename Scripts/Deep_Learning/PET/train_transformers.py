...
Examples:
  ...
  python train_transformers.py --master_csv ~/reseng202500013-ndd-ml/data/pet_labels.csv --data_root ~/reseng202500013-ndd-ml/data/preprocessed/PET --labels 0 1 --model SwinUNETRClassifier --config config_hardware_optimized.yaml --val_ratio 0.2 --test_ratio 0.1
