...
This directory contains implementations of 3D Vision Transformers and Swin UNETR models for PET (Positron Emission Tomography) classification tasks, specifically designed for Alzheimer's Disease (AD) vs Control (CN) classification.
...
```bash
  ...
  python train_transformers.py \
      ...
      --data_root ~/reseng202500013-ndd-ml/data/preprocessed/PET \
      --labels 0 1 \
