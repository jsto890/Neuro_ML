#!/usr/bin/env python3
"""
Ultimate DICOM to NIfTI Converter for CN_SPECT_PPMI dataset
...
def try_pydicom_nibabel_conversion(dicom_dir, output_dir, series_name):
    """Try conversion using pydicom + nibabel (most permissive)"""
...
def main():
    print("=== Ultimate DICOM to NIfTI Converter for CN_SPECT_PPMI ===")
    ...
    output_base = desktop_path / "CN_SPECT_PPMI_NIfTI_Ultimate"
