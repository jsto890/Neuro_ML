...
def main():
    ...
    cmd1 = ["python", "1_reorient.py", "--diagnosis", args.diagnosis]
    if args.force:
        cmd1.append("--force")
    ...
    cmd2 = ["python", "2_normalise.py", "--diagnosis", args.diagnosis, "--method", "reference"]
    ...
    # Step 3: Registration
    cmd3 = ["python", "3_register.py", "--diagnosis", args.diagnosis]
    ...
    cmd4 = ["python", "4_masking.py", "--diagnosis", args.diagnosis]
    ...
    # Step 5: Finalization
    cmd5 = ["python", "5_padding.py", "--diagnosis", args.diagnosis, 
    ...
    cmd6 = ["python", "6_postprocess.py", "--diagnosis", args.diagnosis]
    if args.isHasel:
        cmd6.append("--isHasel")
    ...
    # Run validation
    print("\n🔍 Running validation...")
    cmd_validate = ["python", "testing/validate_pipeline.py", "--diagnosis", args.diagnosis]
    if args.isHasel:
        cmd_validate.append("--isHasel")
    
    run_command(cmd_validate, "Pipeline Validation")
